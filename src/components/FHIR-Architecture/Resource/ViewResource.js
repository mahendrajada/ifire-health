...
const ViewResource = () => {
  ...
  const ViewResourceData = location.state?.ViewResourceData || {};
  const resourceData = ViewResourceData.data;
  const {
    loading,
    loadingoverview,
    loadingig,
                ...
                <div className="table-data-box table-responsive ">
                  {resourceData.name ? (
                    <div className="showDetails">
                      <h5 className="text-white mb-0">{resourceData.name}</h5>
                    </div>
                  ) : (
                    ""
                  )}
